...
- **[qwen-agent](./qwen-agent/SKILL.md)** — Delegate menial, well-scoped coding tasks to a cheap Qwen-backed subagent via `claude-subagent`.
- **[qwen-team](./qwen-team/SKILL.md)** — Split large tasks into subtasks handled by Qwen dev/tester pairs under premium-model orchestration.
